<!--
    {
        "name":"Provision an Oracle Autonomous AI Database",
        "description":"Learn how to provision an Autonomous AI Database using the OCI Console.",
...
- Learn how to provision a new Oracle Autonomous AI Database.
...
5. In the **Configure the database** section, accept the default selections as follows:
    ...
    - **Storage auto scaling**: For this lab, there is no need to enable storage auto scaling, which would allow the system to expand up to three times the reserved storage.
        ...
        ![Choose the remaining parameters.](./images/adb-create-screen-configure-db-new.png)
...
- See the [documentation](https://docs.oracle.com/en/cloud/paas/autonomous-database/serverless/adbsb/work-with-workflows.html) on the typical workflow for using Autonomous AI Database Serverless.
